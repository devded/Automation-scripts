...
class solver:
    """
    solver is the base model to use the fit, evaluate and predict functions of the sklearn library
    """
    ...
    def _create_model(self, **kwargs):
        ...
        model = model_class(**model_args) if model_args else model_class(**kwargs)
    ...
    def fit(self, **kwargs):
        ...
        fit_description = {
            ...
            "arguments": model_args or "default",
    ...
    def create_init_mock_file(
        ...
        dataset_props = solver.default_dataset_props
        model_props = solver.default_model_props
        if model_type:
        ...
        logger.info(f"initalizing a default ML_solver.yaml in {path}")
        default_data = {
            "dataset": dataset_props,
            "model": model_props,
            "target": list(target.split())
            if target
            else ["provide your target(s) here"],
        }
